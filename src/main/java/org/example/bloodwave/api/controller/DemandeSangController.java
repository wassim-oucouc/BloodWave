...
public class DemandeSangController {
    ...
    @PostMapping
    public ResponseEntity<DemandeSangDtoResponse> create(
            @RequestBody DemandeSangDTO dto
    ) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DemandeSangDtoResponse> getById(
    ...
    public ResponseEntity<List<DemandeSangDtoResponse>> getByDemandeur(
